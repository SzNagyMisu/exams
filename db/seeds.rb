...
StudentExercise.seed([ # todo score
    ...
    {id: 13, student_id: 2, exercise_id: 1, solution: '', score: 0},
    {id: 14, student_id: 2, exercise_id: 2, solution: '', score: 0},
    {id: 15, student_id: 2, exercise_id: 3, solution: '', score: 0},
    {id: 16, student_id: 2, exercise_id: 4, solution: '', score: 0},
    {id: 17, student_id: 2, exercise_id: 5, solution: '', score: 0},
    {id: 18, student_id: 2, exercise_id: 6, solution: '', score: 0},
    {id: 19, student_id: 2, exercise_id: 7, solution: '', score: 0},
    {id: 20, student_id: 2, exercise_id: 8, solution: '', score: 0},
    {id: 21, student_id: 2, exercise_id: 9, solution: '', score: 0},
    {id: 22, student_id: 2, exercise_id: 10, solution: '', score: 0},
    {id: 23, student_id: 2, exercise_id: 11, solution: '', score: 0},
    {id: 24, student_id: 2, exercise_id: 12, solution: '', score: 0},
    {id: 25, student_id: 3, exercise_id: 1, solution: '', score: 0},
    {id: 26, student_id: 3, exercise_id: 2, solution: '', score: 0},
    {id: 27, student_id: 3, exercise_id: 3, solution: '', score: 0},
    {id: 28, student_id: 3, exercise_id: 4, solution: '', score: 0},
    {id: 29, student_id: 3, exercise_id: 5, solution: '', score: 0},
    {id: 30, student_id: 3, exercise_id: 6, solution: '', score: 0},
    {id: 31, student_id: 3, exercise_id: 7, solution: '', score: 0},
    {id: 32, student_id: 3, exercise_id: 8, solution: '', score: 0},
    {id: 33, student_id: 3, exercise_id: 9, solution: '', score: 0},
    {id: 34, student_id: 3, exercise_id: 10, solution: '', score: 0},
    {id: 35, student_id: 3, exercise_id: 11, solution: '', score: 0},
    {id: 36, student_id: 3, exercise_id: 12, solution: '', score: 0},
])

StudentExam.seed([
    {id: 1, student_id: 1, exam_id: 1},
    {id: 2, student_id: 1, exam_id: 2},
    {id: 3, student_id: 1, exam_id: 3},
    {id: 4, student_id: 1, exam_id: 4},
    {id: 5, student_id: 2, exam_id: 1},
    {id: 6, student_id: 2, exam_id: 2},
    {id: 7, student_id: 2, exam_id: 3},
    {id: 8, student_id: 2, exam_id: 4},
    {id: 9, student_id: 3, exam_id: 1},
    {id: 10, student_id: 3, exam_id: 2},
    {id: 11, student_id: 3, exam_id: 3},
    {id: 12, student_id: 3, exam_id: 4}
])
